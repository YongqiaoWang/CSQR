...
class CSQR:
    ...
    def __init__(self, y, x, tau, z=None, cet=CET_ADDI, fun=FUN_PROD, rts=RTS_VRS):
        ...
        self.__model__.beta = Var(self.__model__.I, self.__model__.J, domain=NonNegativeReals, doc='beta')
    ...
    def optimize(self, email=OPT_LOCAL, solver=OPT_DEFAULT):
        ...
        for i in self.__model__.I:
            self.__model__.alpha[i].set_value(self.__model__.alpha[i].value+self.__model2__.objective())
